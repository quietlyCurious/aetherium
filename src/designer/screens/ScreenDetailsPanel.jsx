...
export function ScreenDetailsPanel({ editor, queries, self, assetSets, onOpenWizard }) {
  ...
  return (
    <div className="app-panel details-panel aetherium-canvas-scroll">
      ...
      {selectedContainerIds.length <= 1 && selectedContainerId && <ContainerDetails editor={editor} queries={queries} self={self} assetSets={assetSets} />}
    </div>
  );
}
