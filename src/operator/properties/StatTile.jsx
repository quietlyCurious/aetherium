// operator/properties/StatTile.jsx
// StatTile: one property's value as a tile, in any of the view modes
...
export function StatTile({ label, value, min, max, sparkline, labelFirst, horizontal, viewMode = 'all', unit, decimals }) {
