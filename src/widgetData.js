...
// NOTE on the 'data' property type (new): used for any property whose real
// value is a COLLECTION (an array of records, e.g. a grid's rows or a
// chart's series data) rather than a single scalar. There's no sensible
// static "type a value" editor for an array, so properties of this type
// render as bind-only in the details panel (see App.js) — no static input,
// just the binding icon.
